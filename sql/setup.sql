...
('Portfolio Pessoal',            'Site de portfolio responsivo com PHP, PDO e MariaDB, painel admin e login.', 'PHP, MariaDB, SCSS, Git',   'https://github.com/usuario/portfolio',  2026, 'publicado'),
...
('App de Tarefas',               'Lista de tarefas com categorias, prazos e filtro por status.',               'JavaScript, HTML, SCSS',    'https://github.com/usuario/tarefas',    2025, 'publicado'),
...
('SCSS',        'Frontend',       'Linguagem de estilos para apresentacao visual.',   1996),
